"""
Inference — Config C : NLLB-200 + LoRA (configuration principale).
Traduit 20 exemples du split test → outputs/resultats_config_C.docx
"""
import sys, os
...
latest = best_checkpoint(cfg.CHECKPOINTS_C)
...
doc = Document()
doc.add_heading("Résultats — Config C : NLLB-200 + LoRA", 0)
doc.add_paragraph(
    "Seule une petite partie des paramètres est modifiée via LoRA. "
...
output_path = os.path.join(cfg.OUTPUTS_DIR, "resultats_config_C.docx")
