"""Config B — NLLB-200 + Full Fine-Tuning (tous les paramètres modifiés)."""
import sys, os
...
class NLLBFullFineTuner(L.LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        # des noms de fichiers incohérents (observé en pratique: crash D_reverse,
        # best_checkpoint() cherchant un fichier jamais réellement écrit).
